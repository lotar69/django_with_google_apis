...
def Directions(*args, **kwargs):
    ...
    lat_c = kwargs.get("lat_b")
    long_c = kwargs.get("long_b")
    lat_d = kwargs.get("lat_b")
    long_d = kwargs.get("long_b")
    ...
    if directions["status"] == "OK":
        ...
        for route in range(len(routes)):
            ...
            route_step = {
                'origin': routes[route]["start_adress"],
                'destination': routes[route]["end_adress"],
